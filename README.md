...
| Nr | ID | Wymaganie | Nazwa testu | Cel | Przebieg testu | Dane testowe | Oczekiwany rezultat |
|----|----|-----------|-------------|-----|----------------|--------------|---------------------|
| 2 | K2 | System musi zapewniać, że co najmniej 2 kasy są zawsze otwarte.| Sprawdzenie czy 2 kasy są zawsze otwarte | Sprawdzenie czy 2 kasy są zawsze otwarte | Sprawdźić ilość otwartych kas podczas zerowego obłożenia | Oczekujący kibice, otwarte kasy | Zawsze co najmniej 2 kasy są otwarte |
| 3 | K3 | Na każde K/10 kibiców w kolejce musi przypadać co najmniej 1 czynne stanowisko.  Na każde K/10 kibiców w kolejce musi przypadać co najmniej 1 czynne stanowisko.  | Test otwierania kas | Przetestować zachowanie systemu kasowego w przyroście kibiców | Loop dodający kibiców | Oczekujący kibice, otwarte kasy | po przekroczeniu (otwarte kasy * K/10) osób w kolejce, otwiera się kolejna  |
| 4 | K4 | Jeśli liczba osób w kolejce spada poniżej (K/10)*(N-1), jedna kasa jest zamykana | Test zamykania kas | Przetestować zachowanie systemu kasowego w zmniejszającej się kolejce kibiców | Loop odejmujący/przepuszczając kibiców | Oczekujący kibice, otwarte kasy | weryfikacja, czy po spadnięciu poniżej (K/10)*(N-1) kibiców, jedna kasa jest zamykana |
